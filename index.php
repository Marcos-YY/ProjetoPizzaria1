...
?>
    <div id="cliente-banner">
        <h1>Bem vindo!</h1>
    </div>
    <div id="cliente-conteiner">
        <div class="container">
          <div class="row">
              <div class="col-md-12">
                    ...
                    <form action="process/pizza.php" id="pizza-form" method="POST">
                        <div class="form-group">
                            ...
                            <select name="borda" id="borda" class="form-control">
                                <option disabled selected>Selecione a borda</option>
                                <?php foreach ($bordas as $borda): ?>
                                    <option value="<?= $borda["id"] ?>"><?= $borda["tipo"] ?></option>
                                <?php endforeach; ?>  <!--id pra linkar na foreign key-->
                            </select>
                        </div> 
                         <div class="form-group">
                            <label for="massa"> Massa: </label>
                            <select name="massa" id="massa" class="form-control">
                                <option disabled selected>Selecione a massa</option>
